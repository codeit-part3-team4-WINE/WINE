if (!self.define) {
  ...
  self.define = (n, a) => {
    ...
    s[t] = Promise.all(n.map((e) => d[e] || c(e))).then((e) => (a(...e), r));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        { url: '/512x512.png', revision: 'eb22adbd74e99a3f592fcb9b9c25d049' },
        {
          ...
          revision: 'dqKVxYmAqf7w2DZrN7isW',
        },
        {
        ...
        {
          url: '/_next/static/dqKVxYmAqf7w2DZrN7isW/_buildManifest.js',
          revision: '7d15aa7ae9dbfd8a898d46716f7f0b63',
        },
        {
          url: '/_next/static/dqKVxYmAqf7w2DZrN7isW/_ssgManifest.js',
        ...
        { url: '/manifest.json', revision: 'ce1d1596416aa350dfb8f78b76ad78d6' },
      ],
